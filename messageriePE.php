    ...
    <div class="container d-flex justify-content-center">
        <div class="card bg-light mt-5"> 
            ...
            <div class="form-group px-3">
                <button class="send btn btn-default-outline" type="submit" value="soumettre" name="btn_soumettre"><img src="envoi.png" alt="send"> </button>
...
<?php
    ...
    session_start();
    $value1 = $_SESSION['connectionP'];
    $valueP1 = $_SESSION['choixPE'];
    ...
    if(isset($_POST['btn_soumettre']) && $_POST['btn_soumettre']=="soumettre")
    {
        ...
        $sql = "INSERT INTO `messages`(`Message`, `Date`,`ID_eleves`,`ID_Profs`  ) VALUES ('$message',NOW(),'$valueP1','$value1')";
        
        if (mysqli_query($mysqli, $sql)) 
        {
            //AFFICHER TOUS LES MESSAGES DU CHAT DU PROF ET DE L'ELEVE CORRESPONDANT
            $sql1 = "SELECT Message,Date  FROM  messages WHERE ID_eleves='$valueP1' AND ID_profs='$value1'";
