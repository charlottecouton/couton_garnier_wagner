            ...
            if($resultP = $mysqli ->query($sqlP)){
                if($resultP->num_rows>0){
                    while($rowP = $resultP->fetch_row()){
                        echo '<img src="'.$rowP[9].'" class="img-prof" alt="p1"><br/><br>';
                        echo "Nom : ".$rowP[1]."<br/>";
                        ...
                        <button class="btn round btn-outline-success" type="submit" formaction="http://localhost/couton_garnier_wagner/Calendrier/Public/visionP.php">Emploi du temps</button>
                            </form>';
